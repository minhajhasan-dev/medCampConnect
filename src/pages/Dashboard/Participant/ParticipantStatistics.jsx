    ...
    <div>
      <div className="mt-12">
        ...
        <div className="mb-12 max-w-xl mx-auto grid gap-y-10 gap-x-6 md:grid-cols-2 ">
          {/* Sales Card */}
          <div className=" flex justify-center flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
            <div
          ...
          {/* Total Bookings */}
          <div className="relative justify-center flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
            <div
        ...
        <div className="mb-4 mx-auto max-w-2xl grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
          {/* Total Sales Graph */}
